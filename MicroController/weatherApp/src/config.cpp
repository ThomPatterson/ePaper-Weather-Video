...
const uint8_t PIN_BME_SDA = 14;
const uint8_t PIN_BME_SCL = 27;
...
const String OWM_APIKEY   = "YourOpenWeatherMapAPIKey";
...
const String LAT = "38.8718609";
const String LON = "-77.0588418";
// City name that will be shown in the top-right corner of the display.
const String CITY_STRING = "Arlington";
